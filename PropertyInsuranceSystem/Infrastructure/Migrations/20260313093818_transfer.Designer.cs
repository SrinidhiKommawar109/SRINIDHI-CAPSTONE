...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260313093818_transfer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PolicyOwnershipTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NewOwnerPhone")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PolicyOwnershipTransfers");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PolicyTransferDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PolicyTransferDocuments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PolicyOwnershipTransfer", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationUser", "CurrentOwner")
                        .WithMany()
                        .HasForeignKey("CurrentOwnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.PolicyRequest", "Policy")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PolicyTransferDocument", b =>
                {
                    b.HasOne("Domain.Entities.PolicyOwnershipTransfer", "TransferRequest")
                        .WithMany("Documents")
